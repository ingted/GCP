...
{
 "use strict";
 var Global,WebSharper,Google,CodePrettifySample,Client,UI,Next,AttrModule,Operators,Doc,JavaScript,Pervasives,Attrs,DomUtility,AttrProxy,Client$1,DocNode,Array,Unchecked,Arrays,Docs,View,Elt,DocElemNode,List,T,Abbrev,Fresh,Snap,SC$1,Mailbox,Var,Attrs$1,Dyn,Enumerator,Seq,SC$2,Docs$1,RunState,NodeSet,An,Async,T$1,SC$3,Collections,HashSet,Concurrency,Anims,AppendList,SC$4,HashSet$1,Scheduler,SC$5,Easing,DomNodes,OperationCanceledException,CancellationTokenSource,HashSetUtil,SC$6,Lazy,IntelliFactory,Runtime;
 Global=window;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 Google=WebSharper.Google=WebSharper.Google||{};
 CodePrettifySample=Google.CodePrettifySample=Google.CodePrettifySample||{};
 Client=CodePrettifySample.Client=CodePrettifySample.Client||{};
 ...
 {
  var t,res,a,button,a$1;
  Global.PR.prettyPrint();
  t=Global.PR.prettyPrintOne("let f x y = x*y |> true |> \"dvcsdv\"","ml",5);
  res=(a=[AttrModule.Class("prettyprint")],Doc.Element("pre",a,[]));
  button=Doc.Button("Dynamic highlighting",[],function()
  {
   res.elt.innerHTML="let f x y = x*y |> true |> \"dvcsdv\"";
   Global.PR.prettyPrint();
  });
  a$1=Doc.Concat([Doc.Verbatim(t),Doc.Element("br",[],[]),button,res]);
